...
const Privacy = () => {
  ...
  return (
    <section className="mb-24 mt-8 flex flex-col gap-4">
      <h1 className="py-8 text-center text-4xl font-bold">Privacy Policy</h1>
      <span className="bg-gray-300 px-2 py-2 text-center text-orange-800 [text-shadow:0.1rem_0_0.2vw_orange]">
        Last updated: {year < 10 ? "0" + year : year}-
        {month < 10 ? "0" + month : month}-{day < 10 ? "0" + day : day}
      </span>

      <article className="mx-auto mt-8 flex w-2/3 flex-col gap-4 rounded bg-gray-100 px-8 py-8 text-justify font-sans text-sm shadow-sm shadow-gray-400">
        <p className="lowercase text-gray-600 first-letter:capitalize">
        ...
        <ul className="ml-4 flex w-11/12 list-disc flex-col gap-2">
          <li>
            <p className="lowercase first-letter:uppercase">
          ...
          <li>
            <p className="lowercase first-letter:uppercase">
              ...
              in this Agreement) refers to Jayash.
            </p>
          </li>
          ...
          <li>
            <p className="lowercase first-letter:uppercase">
              <strong>Website</strong> refers to Jayash, accessible from{" "}
              <a
                href="https://jayash.com"
        ...
        <h4 className="text-lg italic">Personal Data</h4>
        ...
        <ul className="mb-2 ml-4 flex list-disc flex-col gap-2">
          <li>
            <p className="lowercase first-letter:uppercase">Email address</p>
          </li>
          ...
          <li>
            <p className="lowercase first-letter:uppercase">Usage Data</p>
          </li>
        </ul>

        <h4 className="mt-4 text-lg italic">Usage Data</h4>
        ...
        <h4 className="mt-4 text-lg italic">
        ...
        <h4 className="mt-2 text-lg italic">Business Transactions</h4>
        ...
        <h4 className="mt-2 text-lg italic">Law enforcement</h4>
        ...
        <h4 className="mt-2 text-lg italic">Other legal requirements</h4>
        ...
        <h2 className="mt-8 text-2xl font-bold">Links to Other Websites</h2>
        <p className="lowercase first-letter:uppercase">
        ...
        <ul>
          <li>
            <p className="lowercase first-letter:uppercase">
              By email:{" "}
              <a
                href="mailto:jayashbasnet99@gmail.com"
                className="text-blue-500"
              >
                jayashbasnet99@gmail.com
              </a>
            </p>
          </li>
          <li>
            <p className="lowercase first-letter:uppercase">
              ...
              <a
                href="https://jayash.com/contact"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-500"
              >
                https://jayash.com/contact
              </a>
            </p>
          </li>
        </ul>
